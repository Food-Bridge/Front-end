...
import KakaoBox from '../../component/KakaoLogin/KakaoLogin'
            ...
            <div className='signIn-margin'>
              <div className='signIn-formMargin'>
                <div className='signIn-emailForm'>
                    <input type="text" placeholder='아이디 또는 이메일' className='signIn-emailInput' />
                </div>
                <div className='signIn-passwdForm'>
                    <input type="text" placeholder='비밀번호' className='signIn-passwdInput' />
                </div>  
              </div>
              <div className='signIn-btnMargin'>
                  ...
                  <div className='signIn-signUpBtn'>
                      <SignUpBtn className1={"signUpBtn-frame2"} className2={"signUpBtn-text2"}/>
                  </div>    
