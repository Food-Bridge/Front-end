...
function StoreCard({className, img, storeName, minimumPrice, deliverPrice, storeScore}) {
  return (
        ...
        <div className='storeCard-frame'>
            ...
            <div className='storeCard-textFrame'>
                <div className='storeCard-storeInfo1'>
                    ...
                    <div className='storeCard-storeScore'><IoIosStar className='storeCard-starIcon'/>&nbsp;{storeScore}</div>
                </div>
                <div className='storeCard-storeInfo2'>
                    <div className='storeCard-leastPrice'>
                        <p className='storeCard-leastTitle'>최소주문금액 &nbsp;</p> 
                        <p className='storeCard-leastCount'>&nbsp;{minimumPrice}원&nbsp;&nbsp;</p>
                    </div>
                    <div className='storeCard-deliverPrice'>
                        <p className='storeCard-deliverTitle'>배달팁 &nbsp;</p> 
                        <p className='storeCard-deliverCount'>&nbsp;{deliverPrice}원&nbsp;&nbsp;</p>
                    </div>
                </div>
            </div>
        </div>
